...
Target positioning for roles centered on Python automation, RAG/OSINT, local AI, operational dashboards, report automation, APIs, and AI-assisted workflow systems.
...
- [[projects/opera-pms-data-intelligence-tool/project]]

## Safe positioning notes

Use phrases such as "builds", "prototypes", "experiments with", and "designs operational tools" unless a record proves production adoption or measurable impact. The strongest evidence is practical implementation breadth across Python dashboards, local AI runtime experiments, RAG/OSINT reporting, and hotel operations automation.
